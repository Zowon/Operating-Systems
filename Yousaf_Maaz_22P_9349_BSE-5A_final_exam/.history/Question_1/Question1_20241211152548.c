...
void *Embedded_system_t1()
{
    ...
    printf("Security system: starting...Intializing...\n");
    sem_wait(&semaphore);

    printf("Security camera: starting...Intializing...\n");
    sem_wait(&semaphore);
    return NULL;
}

void *Embedded_system_t2()
{
    sleep(5);
    printf("Thermostats: updated status...(5 seconds)\n");
    sem_post(&semaphore); // Signal to Embedded_system_t1
    ...
    sleep(10);
    printf("security system updated status...(10 seconds)\n");
    sem_post(&semaphore); // Signal to Embedded_system_t1
    sleep(4);
    printf("security camera updated status...(4 seconds)\n");
    sem_post(&semaphore); // Signal to Embedded_system_t1
}
...
int main()
{
    ...
    sesem_init(&semaphore, 0, 0);m_init(&semaphore, 0, 0);
